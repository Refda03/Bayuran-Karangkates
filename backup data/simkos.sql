...
CREATE TABLE `booking` (
  `id_booking` int(11) NULL,
  `id_user` int(11) NULL,
  `id_kamar` int(11) NULL,
  `tanggal_masuk` date NULL,
  `hitungan_sewa` int(11) NULL,
  `durasi_sewa` int(11) NULL,
  `tanggal_keluar` date NULL,
  `jumlah_kamar` int(11) NULL
...
CREATE TABLE `kamar` (
  ...
  `id_kost` int(11) NULL,
  `jumlah_kamar` int(11) NULL,
  `panjang_kamar` int(11) NULL,
  `lebar_kamar` int(11) NULL,
  `tipe_kamar` varchar(255) NULL,
  `biaya_fasilitas` int(11) NULL,
  `fasilitas_kamar` varchar(255) NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `kost` (
  `id_kost` int(11) NULL,
  `nama_kost` varchar(255) NULL,
  `tipe_kost` varchar(255) NULL,
  `jenis_kost` varchar(255) NULL,
  `jumlah_kamar` int(11) NULL,
  `tanggal_tagih` date NULL,
  `nama_pemilik` text NULL,
  `nama_bank` text NULL,
  `no_rekening` int(11) NULL,
  `foto_bangunan_utama` varchar(255) NULL,
  `foto_kamar` varchar(255) NULL,
  `foto_kamar_mandi` varchar(255) NULL,
  `foto_interior` varchar(255) NULL,
  `provinsi` varchar(25) NULL,
  `kota` varchar(25) NULL,
  `kecamatan` varchar(25) NULL,
  `kelurahan` varchar(25) NULL,
  `alamat` varchar(255) NULL,
  `harga_sewa` int(11) NULL,
  `kontak` varchar(255) NULL,
  `deskripsi` text NULL,
  `id_pemilik` int(11) NULL,
  `fasilitas_kost` text NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tagihan` (
  `no_tagihan` int(11) NULL,
  `no_booking` int(11) NULL,
  `total_tagihan` int(11) NULL,
  `stats` int(11) NULL,
...
CREATE TABLE `user` (
  ...
  `jenis_kelamin` varchar(25) NULL,
  `foto_ktp` varchar(255) NULL,
  `foto_profil` text NULL,
  `roles` int(11) NULL,
  `id_kost_saya` int(11) NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `booking`
  MODIFY `id_booking` int(11) NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `kamar`
--
ALTER TABLE `kamar`
  MODIFY `id_kamar` int(11) NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `kost`
--
ALTER TABLE `kost`
  MODIFY `id_kost` int(11) NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `rating`
--
ALTER TABLE `rating`
  MODIFY `id_rating` int(11) NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `roles_user`
--
ALTER TABLE `roles_user`
  MODIFY `id_roles` int(11) NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `tagihan`
--
ALTER TABLE `tagihan`
  MODIFY `no_tagihan` int(11) NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `user`
--
ALTER TABLE `user`
  MODIFY `id` int(11) NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT untuk tabel `wishlist`
--
ALTER TABLE `wishlist`
  MODIFY `id_wishlist` int(11) NULL AUTO_INCREMENT;
