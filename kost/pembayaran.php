...
<div class="container">
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="col">
                <button type="button" class="btn-primary" onclick="redirectToTagihan()">Verifikasi Pembayaran</button>
            </div>
            <!-- <div class="col">
                <a href="halaman_tagihan.php?id=<?php echo $id_kost; ?>" class="btn-primary">Verifikasi Pembayaran</a>
            </div> -->
        </div>
    </div>
</div>
...
<script>
    function redirectToTagihan() {
        window.location.href = "tagihan.php?id=<?php echo $id_kost; ?>";
    }
</script>
