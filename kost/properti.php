...
<div class="container">
  <h3 class="text-center">List Tagihan</h3>
  <hr>
  <div class="container">
    ...
    <table class="table">
      ...
      <tbody>
        <div class="row ">
          ...
          <div class="col-md-2"><a href="tambah_kos.php"><button class="btn-primary">Tambah tagihan</button></a></div>
        </div>
        <br>
        <?php
        $i = 0;
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="penyewa.php?id_kost=<?php echo $d['id_kost']; ?>"><button class="btn-dark">List Transaksi</button></a>
