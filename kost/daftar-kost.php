...
<div class="container">
        ...
        <div class="row">
          ...
          <div class="col my-auto">
            <div class="input-group">
              <input placeholder="Cari tagihan sekarang" autofocus autocomplete="off" type="text" name="cari" class="form-control border-0 small">
        ...
        // filter provinsi  
          <div class="col-md-2">
            ...
            <select class="form-control " name="provinsi" id="provinsi">
              ...
              ?>
                <option value=<?php // echo $n['provinsi'] 
                              ?>><?php // echo $n['provinsi'] 
                                  ?></option>
              <?php
              //}
          ...
          <div class="col-md-2">
            ...
            <select class="form-control " name="jenis_kost" id="jenis_kost">
              ...
              ?>
                <option value=<?php //echo $l['jenis_kost'] 
                              ?>><?php //echo $l['jenis_kost'] 
                                  ?></option>
              <?php
              //}
              ?>
  ...
  if (isset($_GET['cari'])) {
    ...
    // }
    // echo  $provinsi;
    $data = mysqli_query($koneksi, "SELECT * FROM kost JOIN user ON kost.id_pemilik = user.id WHERE nama_kost");
  } else {
            ...
            <a style="text-decoration: none;color:black" href="tampilan-kost.php?id_kost=<?php echo $d['id_kost'] ?>">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col">
                    <div class="card-text">
                      <h6 class="card-title font-weight-bold mb-1" style="font-size:20px;font-weight:bold"><?php echo $d['nama_kost'] ?></h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col-md-7" style="font-size:19px;font-weight:bold">Rp. <?php echo number_format($d['harga_sewa'] + minfas($d['id_kost'], $d['tipe_kost']), 0, ',', '.') . '' . $d['tipe_kost'] ?></div>
                  <?php
