  ...
  <div class="container">
    <div class="container-fluid">
      ...
      <div class="keterangan-biaya">
        ...
        <div class="row">
          <div class="col-md-2">Nominal biaya:</div>
          <div class="col">
            <!-- PHP Echo Statement -->
            <?php
        ...
        <div class="row">
          ...
          <div class="col">
            <!-- PHP Echo Statement -->
            <?php echo "Rp." . number_format($biaya, 0, ',', '.') ?>
      ...
      <div class="pilih-metode-pembayaran" style="display: flex; flex-direction: column; gap: 10px">
...
$kirim = mysqli_query($koneksi, "INSERT INTO booking VALUES ('','$id_user','$id_kost','$hitungan_sewa','$durasi_sewa')");
