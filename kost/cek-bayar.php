...
// booking 
$query = "SELECT * FROM booking join tagihan on booking.id_booking=tagihan.no_booking join kost on kost.id_kost=booking.id_kost join user on user.id=booking.id_user WHERE tagihan.no_tagihan='$id_tagihan' ";
...
<div class="container">
    <form action="php/validasi_proses.php" method="post">
        ...
        <div class="row">
            <div class="col-md-3 ">
                Struk Bukti Pembayaran Transfer
                <img class="img-fluid" width="800px" src="../img/bukti_bayar/<?php echo $d['bukti_bayar'] ?>" alt="">
            </div>
            <div class="col">
                <!-- <div class="row">
        ...
        <div class="row">
            <div class="col">
                <input required class=" form-check-input" type="checkbox" name="" id="">Apakah anda yakin transaksi benar dan telah mengecek STRUK PEMBAYARAN
            </div>
        </div>
        <br>
        <div class="row">
