    ...
    <div class="card">
      ...
      <div class="card-body">
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="container">
                  ...
                  <div class="row">
                    <div class="card-title">
                      <label for="">Deskripsi tagihan</label>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td><?php //if ($l['jumlah_kamar'] > 0) {
                                  ...
                                  ?></td>
                              <td><?php //echo $l['tipe_kamar'] 
                                  ?></td>
                              <td><?php //echo $l['fasilitas_kamar'] 
                                  ?></td>
                              <td><?php //echo number_format(fas($l['biaya_fasilitas'], $d['tipe_kost']) + $d['harga_sewa'], 0, ',', '.') . "/" . $d['tipe_kost'] 
                                  ?></td>
                            </tr>
                          </tbody>
                        <?php //}
        ...
        <div class="col bg-light py-lg-4 text-center">
          <div class="container">
            <div class="row">
              <h6>Rp. <?php echo number_format($d['harga_sewa']); ?> / <?php echo $d['tipe_kost'] ?></h6>
            </div>
            <hr>
            <!-- <div class="row">
            ...
            <!-- <div class="row">
                <div style="position:fixed;right:20px;bottom:20px;">
                  <a target="_blank" href="https://api.whatsapp.com/send?phone=<?php //echo $d['kontak'] 
                                                                                ?>&text=Assalamualaikum, apakah ini bapak/ibu yang mengiklan kost <?php echo $d['nama_kost'] ?> di website simkos ">
                    <button style="background:#f50251;vertical-align:center;height:36px;border-radius:5px">
                      <img src="https://www.freepnglogos.com/uploads/whatsapp-png-image-9.png"></button></a>
                </div>
              </div>
            </div>
          </div> -->
          ...
          <div class="row">
            ...
            if ($n['roles'] == 1) {
              # code...
            ?>
              <div class="col-md-2"><a href="booking.php?id_kost=<?php echo $d['id_kost'] ?>"><button class="btn-primary">Bayar Tagihan</button></a></div>
