...
<div class="container">
    ...
    <form enctype="multipart/form-data" action="booking-2.php?id_kost=<?php echo $id_kost; ?>" method="post" id="form1" class="form-group">
        ...
        <br> -->
        <h3>Apakah Data Dirimu Sesuai?</h3>
        <hr>
        <p style="color:red;font-size: 20px">Pastikan data dirimu sesuai untuk mempermudah petugas memvalidasi</p>
        <div class="row">
            <div class="col"><label for="nama_lengkap">Nama Lengkap</label>
                <input value="<?php echo $d['nama_lengkap'] ?>" type="text" name="nama_lengkap" class="form-control">
            </div>
        </div><br>
        <div class="row">
            <div class="col">
