...
$query = "SELECT * FROM booking join kost on kost.id_kost=booking.id_kost JOIN user on user.id=booking.id_user JOIN tagihan on tagihan.no_booking=booking.id_booking WHERE user.username='$username'";
